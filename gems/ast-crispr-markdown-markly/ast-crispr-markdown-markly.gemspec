...
# kettle-jem:freeze
# To retain chunks of comments & code during ast-crispr-markdown-markly templating:
...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/ast/crispr/markdown/markly/version.rb", mod) }::Ast::Crispr::Markdown::Markly::Version::VERSION
  else
    ...
    require "ast/crispr/markdown/markly/version"
    Ast::Crispr::Markdown::Markly::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "ast-crispr-markdown-markly"
  spec.version = gem_version
  spec.authors = ["Peter H. Boling"]
  spec.email = ["info@structuredmerge.org"]
  spec.summary = "🧬 Markly adapter for AST CRISPR structural edits"
  spec.description = "🧬 Markdown/Markly heading section selectors and edit helpers for ast-crispr."
  ...
  spec.metadata["homepage_uri"] = "https://ast-crispr-markdown-markly.galtzo.com/"
  ...
  # The 'git' gem is optional; ast-crispr-markdown-markly falls back to shelling out to `git` if it is not present.
