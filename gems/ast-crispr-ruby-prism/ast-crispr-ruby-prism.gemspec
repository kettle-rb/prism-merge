...
# kettle-jem:freeze
# To retain chunks of comments & code during ast-crispr-ruby-prism templating:
...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/ast/crispr/ruby/prism/version.rb", mod) }::Ast::Crispr::Ruby::Prism::Version::VERSION
  else
    ...
    require "ast/crispr/ruby/prism/version"
    Ast::Crispr::Ruby::Prism::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "ast-crispr-ruby-prism"
  ...
  spec.metadata["homepage_uri"] = "https://ast-crispr-ruby-prism.galtzo.com/"
  ...
  # The 'git' gem is optional; ast-crispr-ruby-prism falls back to shelling out to `git` if it is not present.
