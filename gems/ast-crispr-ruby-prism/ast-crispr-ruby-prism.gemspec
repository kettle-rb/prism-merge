...
require_relative "lib/ast/crispr/ruby/prism/version"

Gem::Specification.new do |spec|
  spec.name = "ast-crispr-ruby-prism"
  spec.version = Ast::Crispr::Ruby::Prism::VERSION
  ...
  spec.add_dependency "ast-crispr", "= #{Ast::Crispr::Ruby::Prism::VERSION}"
