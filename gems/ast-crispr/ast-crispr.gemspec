...
# kettle-jem:freeze
# To retain chunks of comments & code during ast-crispr templating:
...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/ast/crispr/version.rb", mod) }::Ast::Crispr::Version::VERSION
  else
    ...
    require "ast/crispr/version"
    Ast::Crispr::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://ast-crispr.galtzo.com/"
  ...
  # The 'git' gem is optional; ast-crispr falls back to shelling out to `git` if it is not present.
