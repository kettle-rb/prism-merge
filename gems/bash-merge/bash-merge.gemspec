...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/bash/merge/version.rb", mod) }::Bash::Merge::Version::VERSION
  else
    ...
    require "bash/merge/version"
    Bash::Merge::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "bash-merge"
  spec.version = gem_version
  spec.authors = ["Peter H. Boling"]
  spec.email = ["info@structuredmerge.org"]
  spec.summary = "☯️ Structured Merge Bash analysis and merge for Ruby"
  spec.description = "☯️ Bash statement, comment, freeze-block, and template merge behavior for Structured Merge."
  ...
  spec.metadata["homepage_uri"] = "https://bash-merge.galtzo.com/"
  ...
  # The 'git' gem is optional; bash-merge falls back to shelling out to `git` if it is not present.
