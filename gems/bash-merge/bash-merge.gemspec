...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Structured Merge Bash analysis and merge for Ruby"
  spec.description = "Bash statement, comment, freeze-block, and template merge behavior for Structured Merge."
