...
`Parslet::Toml::Merge` is a Ruby provider package for the TOML merge family. TOML provider backed by Parslet. It registers its backend with `tree_haver` and exposes provider-specific defaults while preserving the canonical family contract.

### Key Features

- Backend registration for `Parslet TOML`.
...
```console
bundle add parslet-toml-merge
```

If bundler is not being used to manage dependencies, install the gem by executing:

```console
gem install parslet-toml-merge
```
...
profile = Parslet::Toml::Merge.toml_backend_feature_profile(backend: :parslet)
context = Parslet::Toml::Merge.toml_plan_context(backend: :parslet)
```

Use this package when you want a hard dependency on the `Parslet TOML` backend. Use the canonical family package when backend auto-selection is preferred.
...
result = Parslet::Toml::Merge.merge_toml(
  File.read("template.toml"),
  File.read("destination.toml"),
  "toml",
  backend: :parslet,
)

abort result.fetch(:diagnostics).inspect unless result.fetch(:ok)
File.write("destination.toml", result.fetch(:output))
```
...
```ruby
spec.add_dependency("parslet-toml-merge", "~> 0.0")
```
...
[gh-discussions]: https://github.com/structuredmerge/parslet-toml-merge/discussions
...
[⛳️gem-namespace]: https://github.com/structuredmerge/parslet-toml-merge
[⛳️namespace-img]: https://img.shields.io/badge/namespace-Parslet::Toml::Merge-3C2D2D.svg?style=square&logo=ruby&logoColor=white
[⛳️gem-name]: https://bestgems.org/gems/parslet-toml-merge
[⛳️name-img]: https://img.shields.io/badge/name-parslet--toml--merge-3C2D2D.svg?style=square&logo=rubygems&logoColor=red
[⛳️tag-img]: https://img.shields.io/github/tag/structuredmerge/parslet-toml-merge.svg
[⛳️tag]: http://github.com/structuredmerge/parslet-toml-merge/releases
[🚂maint-blog]: http://www.railsbling.com/tags/parslet-toml-merge
...
[🏙️entsup-tidelift]: https://tidelift.com/subscription/pkg/rubygems-parslet-toml-merge?utm_source=rubygems-parslet-toml-merge&utm_medium=referral&utm_campaign=readme
[🏙️entsup-tidelift-img]: https://img.shields.io/badge/Tidelift_and_Sonar-Enterprise_Support-FD3456?style=for-the-badge&logo=sonar&logoColor=white
[🏙️entsup-tidelift-sonar]: https://blog.tidelift.com/tidelift-joins-sonar
[💁🏼‍♂️peterboling]: http://www.peterboling.com
[🚂railsbling]: http://www.railsbling.com
[📜src-gl-img]: https://img.shields.io/badge/GitLab-FBA326?style=for-the-badge&logo=Gitlab&logoColor=orange
[📜src-gl]: https://gitlab.com/structuredmerge/parslet-toml-merge/
[📜src-cb-img]: https://img.shields.io/badge/CodeBerg-4893CC?style=for-the-badge&logo=CodeBerg&logoColor=blue
[📜src-cb]: https://codeberg.org/structuredmerge/parslet-toml-merge
[📜src-gh-img]: https://img.shields.io/badge/GitHub-238636?style=for-the-badge&logo=Github&logoColor=green
[📜src-gh]: https://github.com/structuredmerge/parslet-toml-merge
[📜docs-cr-rd-img]: https://img.shields.io/badge/RubyDoc-Current_Release-943CD2?style=for-the-badge&logo=readthedocs&logoColor=white
[📜docs-head-rd-img]: https://img.shields.io/badge/YARD_on_Galtzo.com-HEAD-943CD2?style=for-the-badge&logo=readthedocs&logoColor=white
[📜gl-wiki]: https://gitlab.com/structuredmerge/parslet-toml-merge/-/wikis/home
[📜gh-wiki]: https://github.com/structuredmerge/parslet-toml-merge/wiki
[📜gl-wiki-img]: https://img.shields.io/badge/wiki-gitlab-943CD2.svg?style=for-the-badge&logo=gitlab&logoColor=white
[📜gh-wiki-img]: https://img.shields.io/badge/wiki-github-943CD2.svg?style=for-the-badge&logo=github&logoColor=white
[👽dl-rank]: https://bestgems.org/gems/parslet-toml-merge
[👽dl-ranki]: https://img.shields.io/gem/rd/parslet-toml-merge.svg
[👽version]: https://bestgems.org/gems/parslet-toml-merge
[👽versioni]: https://img.shields.io/gem/v/parslet-toml-merge.svg
[🏀qlty-mnt]: https://qlty.sh/gh/structuredmerge/projects/parslet-toml-merge
[🏀qlty-mnti]: https://qlty.sh/gh/structuredmerge/projects/parslet-toml-merge/maintainability.svg
[🏀qlty-cov]: https://qlty.sh/gh/structuredmerge/projects/parslet-toml-merge/metrics/code?sort=coverageRating
[🏀qlty-covi]: https://qlty.sh/gh/structuredmerge/projects/parslet-toml-merge/coverage.svg
[🏀codecov]: https://codecov.io/gh/structuredmerge/parslet-toml-merge
[🏀codecovi]: https://codecov.io/gh/structuredmerge/parslet-toml-merge/graph/badge.svg
[🏀coveralls]: https://coveralls.io/github/structuredmerge/parslet-toml-merge?branch=main
[🏀coveralls-img]: https://coveralls.io/repos/github/structuredmerge/parslet-toml-merge/badge.svg?branch=main
[🖐codeQL]: https://github.com/structuredmerge/parslet-toml-merge/security/code-scanning
[🖐codeQL-img]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/codeql-analysis.yml/badge.svg
[🚎2-cov-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/coverage.yml
[🚎2-cov-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/coverage.yml/badge.svg
[🚎3-hd-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/heads.yml
[🚎3-hd-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/heads.yml/badge.svg
[🚎5-st-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/style.yml
[🚎5-st-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/style.yml/badge.svg
[🚎9-t-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/truffle.yml
[🚎9-t-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/truffle.yml/badge.svg
[🚎10-j-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/jruby.yml
[🚎10-j-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/jruby.yml/badge.svg
[🚎11-c-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/current.yml
[🚎11-c-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/current.yml/badge.svg
[🚎12-crh-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/dep-heads.yml
[🚎12-crh-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/dep-heads.yml/badge.svg
[🚎13-🔒️-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/locked_deps.yml
[🚎13-🔒️-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/locked_deps.yml/badge.svg
[🚎14-🔓️-wf]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/unlocked_deps.yml
[🚎14-🔓️-wfi]: https://github.com/structuredmerge/parslet-toml-merge/actions/workflows/unlocked_deps.yml/badge.svg
...
[🤝gh-issues]: https://github.com/structuredmerge/parslet-toml-merge/issues
[🤝gh-pulls]: https://github.com/structuredmerge/parslet-toml-merge/pulls
[🤝gl-issues]: https://gitlab.com/structuredmerge/parslet-toml-merge/-/issues
[🤝gl-pulls]: https://gitlab.com/structuredmerge/parslet-toml-merge/-/merge_requests
[🤝cb-issues]: https://codeberg.org/structuredmerge/parslet-toml-merge/issues
[🤝cb-pulls]: https://codeberg.org/structuredmerge/parslet-toml-merge/pulls
[🤝cb-donate]: https://donate.codeberg.org/
[🤝contributing]: https://github.com/structuredmerge/structuredmerge-ruby/blob/main/CONTRIBUTING.md
[🏀codecov-g]: https://codecov.io/gh/structuredmerge/parslet-toml-merge/graphs/tree.svg
[🖐contrib-rocks]: https://contrib.rocks
[🖐contributors]: https://github.com/structuredmerge/parslet-toml-merge/graphs/contributors
[🖐contributors-img]: https://contrib.rocks/image?repo=structuredmerge/parslet-toml-merge
[🚎contributors-gl]: https://gitlab.com/structuredmerge/parslet-toml-merge/-/graphs/main
...
[🚎yard-current]: http://rubydoc.info/gems/parslet-toml-merge
[🚎yard-head]: https://parslet-toml-merge.galtzo.com
[💎stone_checksums]: https://github.com/galtzo-floss/stone_checksums
[💎SHA_checksums]: https://gitlab.com/structuredmerge/parslet-toml-merge/-/tree/main/checksums
