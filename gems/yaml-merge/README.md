...
`Yaml::Merge` is the canonical YAML family package. It validates YAML through `tree_haver`, loads mapping documents with Ruby's YAML support, merges mapping owners by path, and preserves destination values for arrays and existing keys.
