...
module Prism
  module Merge
    ...
    class GemspecVarRenamer
      ...
      def self.rename(source, old_var:, new_var:)
      ...
      def self.collect_receiver_offsets(program_node, old_var)
        offsets = Set.new
        visitor = ReceiverCollector.new(old_var, offsets)
        visitor.visit(program_node)
        offsets.to_a.sort
      end
      private_class_method :collect_receiver_offsets
      ...
      def self.apply_replacements(source, offsets, old_var, new_var)
        result = source.dup
      ...
      private_class_method :apply_replacements
