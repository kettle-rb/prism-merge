...
#         analysis = described_class.new(invalid_content, freeze_token: "kettle-dev")
...
#         expect(block).to be_a(Prism::Merge::FreezeNode)
#         expect(block.location.cover?(3)).to be true
#       end
#     end
