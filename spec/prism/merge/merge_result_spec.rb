...
RSpec.describe Prism::Merge::MergeResult do
  ...
  describe "#add_node with non-contiguous leading comments" do
    let(:result) { described_class.new }

    context "with template source and blank lines between leading comments" do
    ...
    context "with destination source and blank lines between leading comments" do
      it "preserves blank lines between non-contiguous leading comments" do
        content = <<~RUBY
          # First comment
