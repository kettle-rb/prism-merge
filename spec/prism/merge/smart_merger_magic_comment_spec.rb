...
RSpec.describe "Magic comment handling", type: :integration do
  ...
  describe "files with Ruby code" do
    ...
    context "edge case: block with leading magic comment might be reordered" do
    ...
    context "multiple magic comments (encoding + frozen_string_literal)" do
      let(:template) do
        <<~RUBY
          # encoding: UTF-8
          # frozen_string_literal: true
