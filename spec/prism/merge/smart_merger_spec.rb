...
RSpec.describe Prism::Merge::SmartMerger do
  describe "#merge" do
    ...
    context "with comments" do
      ...
      it "preserves aligned destination inline comment spacing when reattaching destination inline comments" do
        template = <<~RUBY
          # frozen_string_literal: true
      ...
      it "preserves template-owned trailing spaces before reattaching destination inline comments" do
        template = <<~RUBY
          # frozen_string_literal: true
